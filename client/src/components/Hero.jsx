...
const Hero = () => {
  ...
  return (
    <div className="px-4 sm:px-20 xl:px-32 relative flex flex-col w-full items-center justify-center text-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl sm:text-5xl md:text-6xl 2xl:text-7xl font-semibold leading-[1.2]">
          Generate Blogs, Images & More with
          <br /> <span className="text-primary">AI tools.</span>
        </h1>
        <p className="mt-4 max-w-xs sm:max-w-lg  2xl:max-w-xl m-auto max-sm:text-xs text-gray-600">
          Create blogs, articles, resumes, reviews, and images instantly with
          our all-in-one AI content generation platform.
        </p>
      </div>
